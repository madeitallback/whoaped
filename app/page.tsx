...
export default function HomePage() {
  return <main className="product-shell">
    <nav className="app-nav"><Link className="wordmark" href="/">WHOAPED<span>•</span></Link><div><Link className="active" href="/">TOKENS</Link><Link href="/leaderboard">LEADERBOARD</Link><Link href="/methodology">METHOD</Link></div><span className="live-state"><i />SOLANA LIVE</span></nav>
    ...
    <footer className="product-footer"><b>WHOAPED</b><p>The KOLScan of social trading. Evidence first; coverage always visible.</p><div><Link href="/methodology">READ THE METHOD</Link> · <Link href="/leaderboard">OPEN DAILY BOARD ↗</Link></div></footer>
  </main>;
}
