...
- [ ] Provision the user's Browserbase project/API key, create the persistent Context through `pnpm fomo:browserbase:connect`, add the three encrypted Production variables to Vercel, redeploy, and record two consecutive successful scheduled refreshes with non-zero counts.
